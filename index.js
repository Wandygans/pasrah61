require('./config')
const { default: hisokaConnect, useSingleFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto } = require("@danielteodoro/baileys-md")
...
global.db = new Low(
/https?:\/\//.test('mongodb://StealBot:wandyganteng@botwhatsapp-shard-00-00.synv5.mongodb.net:27017,botwhatsapp-shard-00-01.synv5.mongodb.net:27017,botwhatsapp-shard-00-02.synv5.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-14gv3g-shard-0&authSource=admin&retryWrites=true&w=majority' || '') ?
new cloudDBAdapter('mongodb://StealBot:wandyganteng@botwhatsapp-shard-00-00.synv5.mongodb.net:27017,botwhatsapp-shard-00-01.synv5.mongodb.net:27017,botwhatsapp-shard-00-02.synv5.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-14gv3g-shard-0&authSource=admin&retryWrites=true&w=majority') : /mongodb/.test('mongodb://StealBot:wandyganteng@botwhatsapp-shard-00-00.synv5.mongodb.net:27017,botwhatsapp-shard-00-01.synv5.mongodb.net:27017,botwhatsapp-shard-00-02.synv5.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-14gv3g-shard-0&authSource=admin&retryWrites=true&w=majority') ?
new mongoDB('mongodb://StealBot:wandyganteng@botwhatsapp-shard-00-00.synv5.mongodb.net:27017,botwhatsapp-shard-00-01.synv5.mongodb.net:27017,botwhatsapp-shard-00-02.synv5.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-14gv3g-shard-0&authSource=admin&retryWrites=true&w=majority') :
...
if (anu.action == 'add') {
hisoka.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `Hi @${num.split("@")[0]}👋\nWelcome To ${metadata.subject}\n\n${tes}` })
